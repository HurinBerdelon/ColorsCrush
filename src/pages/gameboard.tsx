...
export default function GamePage(): JSX.Element {
    ...
    const [isScoreRecordsModalOpen, setIsScoreRecordsModalOpen] =
        useState(false);
    ...
    return (
        <ThemeProvider theme={theme}>
            <GameBodyContainer>
                ...
                <ScoreBoard
                    handleOpenThemeRewardModal={handleOpenThemeRewardModal}
                />
                <GameBoard />
                {/* <ScoreRecords historical={historicalScores} /> */}
                <ScoreRecordsModalButton
                    handleOpenScoreRecordsModal={handleOpenScoreRecordsModal}
                />
                <Widget />
